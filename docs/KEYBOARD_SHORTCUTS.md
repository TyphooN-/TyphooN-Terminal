...
| `HEIKINASHI` | Switch to Heikin-Ashi |
| `LINE` | Switch to line chart |
| `OHLC` | Switch to OHLC bars |
| `RENKO` | Switch to Renko chart |
| `EXPORT_CSV` | Export chart data to CSV |
| `NEW_TAB` | Open new chart tab |
