# ADR-022: Data Source Indicator & Pluggable Broker Hierarchy

**Status:** Implemented (Phase 1 + Phase 2)
**Date:** 2026-03-21

> **Note:** Extends [ADR-021](021-data-source-hierarchy-mt5-master-broker-fallback.md) (Data Source Hierarchy) and [ADR-009](009-multi-broker-architecture.md) (Multi-Broker).
