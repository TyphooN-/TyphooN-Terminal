...
- **Export**: Semicolon-delimited CSVs to `/home/typhoon/git/MarketWizardry.org/darwinex-radar/` for web publishing
...
- MarketWizardry.org export provides public transparency on Darwinex symbol changes
