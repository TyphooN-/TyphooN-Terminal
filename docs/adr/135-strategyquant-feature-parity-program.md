...
distribution and remaining results/report workflows; assemble identity-bound sub-bar datasets
through that native path; add exchange/vendor ingestion for historical corporate
