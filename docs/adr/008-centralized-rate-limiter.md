# ADR-008: Centralized Rate Limiter

**Status:** Implemented (v4 — Adaptive)
**Date:** 2026-03-15 (updated 2026-03-20)

> **See also:** [ADR-050](050-broker-bar-data-provider-maximum-history.md) for full-history pagination and [ADR-087](087-alpaca-sync-autotuning-by-data-tier.md) for the later tier-aware Alpaca pacing/window-sizing work built on top of this limiter.
