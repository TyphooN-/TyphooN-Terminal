# ADR-213: Per-Frame O(1) Discipline in Chart and Sync Paths

**Date:** 2026-05-22
**Status:** Accepted
**Related:** ADR-052 (background data + render decoupling),
...
every frame. ADR-052 already moved expensive DB queries off the render
