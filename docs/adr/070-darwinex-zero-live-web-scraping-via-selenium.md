# ADR-070: Darwinex Zero Live Web Scraping via Selenium
...
**Total workspace test count: 854** (up from 836 in ADR-069).
...
- ADR-024 — DARWIN Import Pipeline & Analytics (foundation)
- ADR-035 — GPU-Accelerated DARWIN Analytics (correlation/VaR compute)
- ADR-055 — DarwinexRadar symbol spec tracking
- ADR-069 — UX Improvements, GPU Compute, Client Parity
