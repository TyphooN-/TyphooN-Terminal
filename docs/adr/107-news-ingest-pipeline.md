# ADR-107 — Multi-source News Ingest Pipeline
...
- ADR-096 — SEC filing expansion (pattern for in-terminal content viewer)
- ADR-100-105 — Deeper wiring passes (LAN sync whitelist precedent)
