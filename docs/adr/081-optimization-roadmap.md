...
All 10 items resolved. MACD periods now user-configurable (12/26/9 defaults). GPU status visible in Help window. Vec allocations reused for indicators. Zero production unwrap/expect (ADR-082).
