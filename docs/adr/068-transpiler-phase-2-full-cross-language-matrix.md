...
ADR-067 landed six new frontends and a Phase 1 cross-language transpiler
...
ADR-067). Subsequent frontend/backend follow-ups have raised
...
- ADR-067 — Multi-frontend expansion + Phase 1 transpiler (direct predecessor)
- ADR-040 — MQL5 compiler pipeline (foundation IR)
- ADR-066 — EasyLanguage + thinkScript compilers
