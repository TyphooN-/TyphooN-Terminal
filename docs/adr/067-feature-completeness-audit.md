...
- **MQL5 compiler** — All TODOs fixed (switch, do-while, assignment, local resolution, continue). 229 tests passing across parser, IR, WASM codegen, WGSL codegen, and the full 10-language transpiler matrix *(updated 2026-05-17 — was 82 at time of writing)*. See ADR-060, ADR-090, ADR-091, ADR-098.
