# ADR-052: Performance Architecture — Background Data + Render Decoupling
...
Stay on latest stable versions of all crates. Do not wait for upstream to mark releases as stable — adopt early, report issues upstream. Security patches applied immediately. Version alignment documented in ADR-051.
