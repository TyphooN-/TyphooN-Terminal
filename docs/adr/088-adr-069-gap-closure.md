...
- ~~**EasyLanguage compiler**~~ **Implemented in ADR-089/090.** Full transpiler backend; follow-ups now provide the full 10-language matrix with 229 mql5-compiler tests.
