...
Current count: 102 ADRs after adding the Kraken equities Alpaca/provider gap-fill proposal, the Kraken iapi AIMD rate-discovery decision, and compacting the Godel/TA-Lib parity rounds, table-wiring passes, and feature-audit closure records.
