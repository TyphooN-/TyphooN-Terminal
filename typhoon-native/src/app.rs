...
mod app_runtime_indicator_extended_snapshots;
mod app_runtime_indicator_snapshots;
...
impl TyphooNApp {
    pub fn new(cc: &eframe::CreationContext<'_>, rt_handle: tokio::runtime::Handle) -> Self {
        ...
        let mut app = Self {
            ...
            deferred_chart_inflight: std::collections::HashMap::new(),
            deferred_chart_load_tx: None,
            deferred_chart_load_rx: None,
            mtf_focused: None,
            mtf_visible: Vec::new(),
            command_open: false,
            ...
            alpaca_account_orders: Vec::new(),
            alpaca_account_fills: Vec::new(),
            alpaca_roster_by_id: std::collections::HashMap::new(),
            alpaca_primary_roster_entry: None,
            alpaca_account_positions_by_id: std::collections::HashMap::new(),
            alpaca_account_orders_by_id: std::collections::HashMap::new(),
            alpaca_account_fills_by_id: std::collections::HashMap::new(),
            ...
            kraken_account_positions: Vec::new(),
            kraken_account_orders: Vec::new(),
            kraken_account_trades: Vec::new(),
            kraken_roster_by_id: std::collections::HashMap::new(),
            kraken_primary_roster_entry: None,
            kraken_account_positions_by_id: std::collections::HashMap::new(),
            kraken_account_orders_by_id: std::collections::HashMap::new(),
            kraken_account_trades_by_id: std::collections::HashMap::new(),
            ...
            claude_model: "fable".to_string(),
            claude_effort: "ultrathink".to_string(),
            show_antigravity_cli: false,
            antigravity_cli_input: String::new(),
            antigravity_cli_history: Vec::new(),
            antigravity_cli_rx: None,
            antigravity_cli_packet: None,
            antigravity_model: Self::default_antigravity_cli_model().to_string(),
            ...
            ai_model: "claude-fable-5".to_string(),
            ai_provider: 0,
            // ── AI session persistence defaults ──
            ai_chat_session_id: String::new(),
            antigravity_cli_session_id: String::new(),
            ...
            show_company_info_window: false,
            company_info_symbol: String::new(),
            company_info_text: String::new(),
            ...
            cached_sector_heatmap: std::sync::Arc::from([]),
            cached_sector_heatmap_key: None,
            cached_dividend_screen: std::sync::Arc::from([]),
            cached_dividend_screen_key: None,
            ...
            cached_kraken_equity_catalog_sig: None,
            cached_alpaca_equity_rotation: std::sync::Arc::new(Vec::new()),
            cached_alpaca_equity_rotation_sig: None,
            ...
            kraken_equity_universe_set: std::collections::HashSet::new(),
            kraken_equity_names: std::collections::HashMap::new(),
            ...
            kraken_universe_digest_rx: None,
            show_reg_sho_window: false,
            show_halts_window: false,
            ...
            alpaca_sync_pause_until_ts: 0,
            alpaca_sync_pause_reason: String::new(),
            alpaca_consecutive_429: 0,
            ...
            show_sma_intelligence: false,
            sma_outfits: typhoon_chart_ui::sma_outfits::default_sma_outfits(),
            sma_outfit_input: String::new(),
            show_stat_arb: false,
            ...
            storage_purge_news_count: None,
            storage_purge_news_count_idx: None,
            storage_purge_news_count_db_total: None,
            storage_purge_news_count_cutoff_ts: None,
            storage_purge_news_count_retry_at: std::time::Instant::now(),
            storage_purge_news_count_rx: None,
            ...
            storage_prune_out_of_scope_kraken_confirm: false,
            storage_out_of_scope_kraken_keys_cache: Vec::new(),
            storage_out_of_scope_kraken_keys_cache_rev: None,
            ...
            storage_sanity_delta: None,
            storage_sanity_last_action: None,
            storage_sanity_filter: String::new(),
            storage_sanity_confirm: None,
            storage_sanity_reaudit_after: false,
            ...
            bg_refetch_probe_last_bar_ts: std::collections::HashMap::new(),
            ...
            alpaca_backfill_complete_reconcile_next_ts: 0,
            ...
            yahoo_chart_backfill_complete_pairs: std::collections::HashMap::new(),
            yahoo_chart_backfill_complete_loaded: false,
            yahoo_chart_backfill_complete_dirty_since: None,
            show_connect: false,
            ...
            alerts: Vec::new(),
            alerts_set: std::collections::HashSet::new(),
            alert_price_input: String::new(),
            indicator_alerts: Vec::new(),
            indicator_alerts_set: std::collections::HashSet::new(),
            ...
            fund_screen_filters: Vec::new(),
            fund_screen_field_idx: 0,
            fund_screen_min: String::new(),
            fund_screen_max: String::new(),
            fund_screen_results: Vec::new(),
            fund_screen_name: String::new(),
            ...
            alpaca_close_qty: 0.0,
            alpaca_close_pct: 100.0,
            ...
            hidden_alpaca_position_account_ids: std::collections::BTreeSet::new(),
            hidden_alpaca_order_account_ids: std::collections::BTreeSet::new(),
            hidden_kraken_position_account_ids: std::collections::BTreeSet::new(),
            hidden_kraken_order_account_ids: std::collections::BTreeSet::new(),
            hidden_alpaca_recent_fill_account_ids: std::collections::BTreeSet::new(),
            hidden_kraken_recent_fill_account_ids: std::collections::BTreeSet::new(),
            hidden_alpaca_risk_account_ids: std::collections::BTreeSet::new(),
            hidden_kraken_risk_account_ids: std::collections::BTreeSet::new(),
            show_alpaca_orders: true,
            show_kr_orders: true,
            show_kraken_trade_history: false,
            show_kraken_open_orders: false,
            live_orders: Vec::new(),
            live_orders_by_id: std::collections::HashMap::new(),
            ...
            last_ui_frame_at: std::time::Instant::now(),
            pump_hidden: false,
            pump_started: std::time::Instant::now(),
            pump_pre_broker_ms: 0.0,
            pump_broker_drain_ms: 0.0,
            pump_msgs_drained: 0,
            pump_session_save_ms: 0.0,
            hidden_pump_passes: 0,
            hidden_pump_msgs: 0,
