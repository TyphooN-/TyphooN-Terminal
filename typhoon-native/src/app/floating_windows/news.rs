                    ...
                    ui.horizontal(|ui| {
                            ...
                            .clicked()
                        {
                            ...
                            if symbols.is_empty() {
                                ...
                                // Clicking Fetch is an explicit request: run it
                                // even mid-catch-up. The old heavy-sync deferral
                                // made Scope ALL unusable for hours at a time,
                                // and the background auto-scrape already backs
