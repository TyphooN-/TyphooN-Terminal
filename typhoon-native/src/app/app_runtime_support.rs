...
pub(super) fn broker_msg_kind(msg: &BrokerMsg) -> &'static str {
    match msg {
        ...
        BrokerMsg::AlpacaAccountOrders(_) => "AlpacaAccountOrders",
        BrokerMsg::OrderResult(_) => "OrderResult",
        BrokerMsg::KrakenTrades(_) => "KrakenTrades",
        BrokerMsg::KrakenAccountTrades(_) => "KrakenAccountTrades",
        BrokerMsg::KrakenLiveTrade(_) => "KrakenLiveTrade",
        BrokerMsg::KrakenAccountPositions(_) => "KrakenAccountPositions",
        BrokerMsg::KrakenOpenOrders(_) => "KrakenOpenOrders",
        BrokerMsg::KrakenAccountOpenOrders(_) => "KrakenAccountOpenOrders",
        ...
        BrokerMsg::AlpacaAccountFills(_) => "AlpacaAccountFills",
