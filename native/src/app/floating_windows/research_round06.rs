...
impl TyphooNApp {
    pub(super) fn render_research_round06_windows(&mut self, ctx: &egui::Context) {
            ...
            egui::Window::new("INDU — Sector Performance")
                ...
                .show(ctx, |ui| {
                    ...
                    if self.sector_perf.is_empty() {
                        ui.label(
                            egui::RichText::new(
                                "No data — click Fetch to pull FMP sector-performance.",
                            )
                            .color(AXIS_TEXT)
                            .small(),
                        );
                                ...
                                egui::Grid::new("indu_grid")
                                    ...
                                    .show(ui, |ui| {
                                        ...
                                        for r in rows.iter() {
                                            ...
                                            ui.label(
                                                egui::RichText::new(&r.sector).small().strong(),
                                            );
                                            ui.label(
                                                egui::RichText::new(format!(
                                                    "{:+.2}%",
                                            ...
                                            let width = (r.change_pct.abs() / max_abs * 30.0)
                                                .round()
                                                as usize;
