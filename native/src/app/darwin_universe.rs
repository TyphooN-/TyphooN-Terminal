...
pub const DARWINEX_USA_EQUITY_SYMBOLS: &[&str] = &[
    ...
    "PCTY", "PDCO", "PEG", "PEAK", "PEP", "PFE", "PFG", "PFGC", "PGR", "PG", "PGR", "PH", "PHM",
    "PII", "PINS", "PIPR", "PK", "PKG", "PKI", "PLD", "PLNT", "PLTR", "PLUG", "PM", "PNC", "PNR",
    "PNW", "POOL", "POR", "POST", "PPC", "PPG", "PPL", "PR", "PRU", "PSA", "PSX", "PTC", "PTON",
    "PUBM", "PVH", "PWR", "PXD", "PYPL", "QCOM", "QGEN", "QRVO", "RCL", "RCM", "REG", "REGN", "RF",
    "RGA", "RGEN", "RGLD", "RHI", "RJF", "RL", "RMD", "RNG", "ROK", "ROL", "ROP", "ROST", "RPRX",
    "RRC", "RRD", "RS", "RSG", "RVTY", "RWE", "RXO", "RY", "RYN", "S", "SAIA", "SAM", "SAND",
    "SBAC", "SBNY", "SBUX", "SCHW", "SCI", "SEDG", "SEE", "SEIC", "SF", "SGEN", "SGEN", "SHW",
    "SIG", "SIVB", "SJM", "SLB", "SLG", "SLM", "SMA", "SMAR", "SMCI", "SMD", "SMFG", "SMG", "SML",
    "SMM", "SMP", "SMR", "SNAP", "SNPS", "SO", "SOFI", "SON", "SPG", "SPGI", "SPLK", "SPOT",
    "SPWR", "SQ", "SR", "SRCL", "SRE", "SRPT", "SSB", "SSNC", "SSO", "STAG", "STLD", "STM", "STT",
    "STX", "STZ", "SU", "SUI", "SUM", "SUN", "SUPN", "SWK", "SWKS", "SWN", "SYF", "SYK", "SYNA",
    "SYY", "T", "TAP", "TAT", "TDC", "TDG", "TDY", "TEAM", "TECH", "TEL", "TER", "TFC", "TFX",
    "TGT", "THC", "THO", "TIF", "TIXT", "TJX", "TKR", "TMO", "TMUS", "TOL", "TOWN", "TPG", "TPR",
    "TRGP", "TRMB", "TROW", "TRP", "TRU", "TRV", "TSCO", "TSLA", "TSN", "TT", "TTWO", "TU", "TUP",
    "TW", "TWLO", "TWO", "TWTR", "TXN", "TXT", "TYL", "UA", "UAA", "UAL", "UBER", "UBS", "UDR",
    "UHAL", "UI", "UL", "ULTA", "UNH", "UNM", "UNP", "UPS", "URI", "USB", "USFD", "USO", "V",
    "VAC", "VAIL", "VAL", "VFC", "VGR", "VGT", "VICI", "VLO", "VMC", "VMW", "VNO", "VNT", "VOO",
    "VRSK", "VRSN", "VRTX", "VSH", "VST", "VTR", "VTRS", "VZ", "WAB", "WAL", "WAT", "WBA", "WBD",
    "WBS", "WCC", "WDC", "WEC", "WELL", "WEN", "WFC", "WHR", "WING", "WIX", "WK", "WLTW", "WM",
    "WMB", "WMT", "WOLF", "WOOF", "WPC", "WPM", "WRB", "WRK", "WSC", "WSM", "WSO", "WST", "WTFC",
    "WTM", "WTRG", "WU", "WW", "WY", "WYNN", "X", "XEL", "XLB", "XLC", "XLE", "XLF", "XLI", "XLK",
    "XLP", "XLR", "XLU", "XLV", "XLY", "XOM", "XPO", "XRAY", "XRX", "XYL", "Y", "YELP", "YETI",
    "YUM", "ZBH", "ZBRA", "ZD", "ZG", "ZION", "ZM", "ZS", "ZTS", "ZWS",
];
