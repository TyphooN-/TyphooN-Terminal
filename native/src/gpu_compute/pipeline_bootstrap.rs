...
pub(super) fn create_multi_indicator_bind_group_layout(
    device: &wgpu::Device,
...
pub(super) fn create_indicator_pipeline_layout(
    device: &wgpu::Device,
...
pub(super) fn create_multi_indicator_pipeline_layout(
    device: &wgpu::Device,
...
pub(super) fn make_indicator_pipeline(
    device: &wgpu::Device,
...
pub(super) fn make_multi_indicator_pipeline(
    device: &wgpu::Device,
    multi_pipeline_layout: &wgpu::PipelineLayout,
    label: &str,
    source: &str,
) -> wgpu::ComputePipeline {
    let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
